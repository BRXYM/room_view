    ...
    <el-container>
      <el-header>
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
          ...
          <el-menu-item index="1" type="primary" @click="drawer = true,getAllusers()">
            帮助
          </el-menu-item>


          
          <el-menu-item index="2" @click="view = 1,drawer = true,getAllusers()" v-show="userLogin === 0">登录</el-menu-item>
          <el-sub-menu index="3" v-show="userLogin === 1">
            <template #title>我的</template>
            <el-menu-item index="3-1" @click="view = 12">个人信息</el-menu-item>
...
// new drawer = ref(false)

const Rate = ref(null)
const colors = ref(['#99A9BF', '#F7BA2A', '#FF9900']) // same as { 2: '#99A9BF', 4: { value: '#F7BA2A', excluded: true }, 5: '#FF9900' }

const helpmenu = ref("1")
