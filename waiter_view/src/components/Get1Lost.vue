<template>
 ...
 <el-table :data="toRaw(lostStore.lostList)" style="width: 100%">
   ...
   <el-table-column fixed="right" label="寻到" width="120">
      <template #default="scope">
        <el-button link type="primary" size="small" @click.prevent="centerDialogVisible = true,getid(scope.$index)">已被寻到</el-button>
      </template>
    </el-table-column>
 </el-table>
 <el-dialog
